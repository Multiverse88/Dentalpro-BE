...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        // Reset data gigi
        yield prisma.patientTooth.deleteMany({});
        yield prisma.treatmentTooth.deleteMany({});
        yield prisma.dentalRecord.deleteMany({});
        yield prisma.treatment.deleteMany({});
        yield prisma.patient.deleteMany({});
        yield prisma.user.deleteMany({});
        yield prisma.tooth.deleteMany({});
        ...
        yield prisma.tooth.createMany({ data: teeth });
        ...
        yield prisma.patient.createMany({ data: fakePatients });
